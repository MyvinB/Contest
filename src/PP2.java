 ...
 */public class PP2 {
    ...
    static void combine(List<int[]> list, List<Integer> path, int n, int k, int start,int b[]){
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(t--!=0){
                ...
                List<int[]> yu=combine(m,zeroCount,a);
                //just printing
